...
export const uiTexts = {
  ...
  ko: {
    ...
    ticketCreatedDesc: '서비스 티켓이 생성되었습니다. 담당자가 곧 연락 드리겠습니다',
    askHuman: '상담원 연결',
  ...
  fr: {
    ...
    ticketCreatedDesc: 'Un ticket de service a été créé, notre agent vous répondra bientôt',
  ...
  de: {
    ...
    ticketCreatedDesc: 'Ein Service-Ticket wurde erstellt, unser Agent wird sich bald melden',
  ...
  es: {
    ...
    ticketCreatedDesc: 'Se ha creado un ticket de servicio, nuestro agente le responderá pronto',
